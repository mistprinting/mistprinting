...
export default function AboutPage() {
  return <><SiteHeader /><main>
    <PageHero eyebrow="About Mist" title="Local attention." accent="Production-minded." description="Mist Printing combines the care of a local Treasure Valley shop with the capability to coordinate substantial orders and ship across the country." />
    <section className="about-story">
      <div className="about-image"><Image src="/work/gallery/floral-heart-shirt.webp" alt="Custom floral heart apparel print by Mist Printing" fill sizes="(max-width: 800px) 100vw, 48vw" /></div>
      <div><p className="section-label">Why Mist</p><h2>Your project should feel exciting—not complicated.</h2><p>Printing often comes with too many choices, unclear steps, and crowded ordering experiences. Mist Printing is built around a simpler idea: understand the job, keep the details moving, and deliver work people are proud to wear or share.</p><p>From business apparel and sporting events to church groups and family reunions, each order is an opportunity to help a group show up together.</p></div>
    </section>
    ...
    <section className="two-link-panel"><div><p className="section-label">See what we make</p><h2>Let the work speak.</h2><Link className="button" href="/our-work">Explore our work ↗</Link></div><div><p className="section-label">Start the conversation</p><h2>Bring us your idea.</h2><Link className="button" href="/contact">Get a quote ↗</Link></div></section>
    <QuoteCta />
  </main><SiteFooter /></>;
}
